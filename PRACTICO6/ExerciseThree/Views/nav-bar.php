      ...
      <nav id="mainav" class="fl_right">
        <ul class="clear">
            ...
            <li><a class="drop" href="#">Cervezas</a>
              <ul>
                <li><a href="<?php echo FRONT_ROOT."Beer/ShowViewsAddBeer" ?>">Agregar</a></li>
                <li><a href="<?php echo FRONT_ROOT."Beer/ShowViewsListBeer" ?>">Ver Listado</a></li>
              </ul>
            </li>
            <li><a class="drop" href="#">Tipos de Cervezas</a>
              <ul>
                <li><a href="<?php echo FRONT_ROOT."BeerType/ShowViewsAddBeerType" ?>">Agregar</a></li>
                <li><a href="<?php echo FRONT_ROOT."BeerType/ShowViewsListBeerType" ?>">Ver Listado</a></li>
              </ul>
            </li>
        </ul>
    </nav> 
